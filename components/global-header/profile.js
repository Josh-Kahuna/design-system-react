...
function (_React$Component) {
  ...
  function GlobalHeaderProfile(props) {
    ...
    _this = _possibleConstructorReturn(this, (GlobalHeaderProfile.__proto__ || Object.getPrototypeOf(GlobalHeaderProfile)).call(this, props));
    (0, _checkProps2.default)(_constants.GLOBAL_HEADER_PROFILE, props);
    return _this;
  }
  ...
  _createClass(GlobalHeaderProfile, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(_popover2.default, popoverProps, _react2.default.createElement(_button2.default, _extends({
        className: (0, _classnames2.default)('slds-global-actions__avatar slds-global-actions__item-action', this.props.buttonClassName),
        title: this.props.userName,
        variant: "icon"
      }, buttonAriaProps), typeof avatar === 'string' ? _react2.default.createElement("span", {
