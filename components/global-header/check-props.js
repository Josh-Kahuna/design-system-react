...
if (process.env.NODE_ENV !== 'production') {
  checkProps = function checkProps(COMPONENT, props, jsonDoc) {
    if (COMPONENT === _constants.GLOBAL_HEADER_BUTTON || COMPONENT === _constants.GLOBAL_HEADER_DROPDOWN) {
      (0, _componentIsDeprecated2.default)(COMPONENT, "".concat(COMPONENT, " has been deprecated in favor of more-specific global header subcomponents. Please see docs for updated examples."));
    }
    ...
    if (COMPONENT === _constants.GLOBAL_HEADER_PROFILE) {
      ...
      (0, _sunsetProperty2.default)(COMPONENT, props.align, 'align');
      (0, _sunsetProperty2.default)(COMPONENT, props.children, 'children', popoverExtraMessage);
      (0, _sunsetProperty2.default)(COMPONENT, props.nubbinPosition, 'nubbinPosition');
      (0, _sunsetProperty2.default)(COMPONENT, props.offset, 'offset');
      (0, _sunsetProperty2.default)(COMPONENT, props.onSelect, 'onSelect');
      (0, _sunsetProperty2.default)(COMPONENT, props.options, 'options', popoverExtraMessage);
    }
