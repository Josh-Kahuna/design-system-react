  ...
  checkProps = function checkProps(COMPONENT, props, jsonDoc) {
    ...
    if (props.children !== undefined) {
      if (props.children.length && props.children.length > 1) {
        (0, _oneOfComponent2.default)(COMPONENT, props, 'children[0]', ['SLDSButton', 'a', 'button'], " Multiple children of any kind are allowed, but the first child must serve as the trigger component. ".concat(createDocUrl()), props.children[0]);
      } else {
