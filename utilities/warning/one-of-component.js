...
if (process.env.NODE_ENV !== 'production') {
  ...
  oneOfComponent = function oneOfComponent(control, props, propName, allowedComponents, comment, specificTest // if this is set, it will be checked instead of props[propName]
    ...
    if (!allowedComponentFound && !hasWarned[control]) {
      ...
      (0, _warning2.default)(false, "[Design System React] ".concat(control, " requires that prop '").concat(propName, "' is an instance of one of the following components: ").concat(allowedComponents.join(', '), ". An instance of '").concat(componentType, "' was given.").concat(additionalComment));
